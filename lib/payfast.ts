...
/**
 * PayFast doc order for signature (their examples use this order).
 * We use this order for BOTH:
 * - the payment form we send to PayFast
 * - the ITN/webhook verification
 *
 * That way our signature generation is consistent for both directions.
